...
export default function Footer() {
  return (
    <footer className="bg-[#69300a] text-white py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            ...
            <div className="flex space-x-4">
              <a href="#" className="text-white hover:text-[#f0b227]" aria-label="Facebook">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512" className="w-5 h-5 fill-current">
                  <path d="M279.14 288l14.22-92.66h-88.91v-60.13c0-25.35 12.42-50.06 52.24-50.06h40.42V6.26S260.43 0 225.36 0c-73.22 0-121.08 44.38-121.08 124.72v70.62H22.89V288h81.39v224h100.17V288z"/>
                </svg>
              </a>
              <a href="#" className="text-white hover:text-[#f0b227]" aria-label="Twitter">
              ...
              <a href="#" className="text-white hover:text-[#f0b227]" aria-label="Instagram">
