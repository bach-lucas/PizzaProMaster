        ...
        <div className="container mx-auto px-4 py-12">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center max-w-5xl mx-auto">
            ...
            <div className="bg-[#2C5530] text-white p-8 rounded-lg hidden md:block">
              <h2 className="font-heading text-3xl font-bold mb-4">Pizza Deliciosa ao Seu Alcance</h2>
              <p className="mb-6">
                Crie uma conta para desfrutar de ofertas exclusivas, acompanhar seus pedidos e salvar seus sabores favoritos para pedidos rápidos.
              </p>
