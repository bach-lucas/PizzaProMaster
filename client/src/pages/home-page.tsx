            ...
            <div className="flex flex-col md:flex-row items-center">
              <div className="md:w-1/2 mb-8 md:mb-0 md:pr-8">
                ...
                <p className="text-gray-700 mb-4">
                  Na ZZA, estamos preparando autênticas pizzas italianas há mais de 25 anos. Nossas receitas foram transmitidas por gerações, e temos orgulho de usar apenas os ingredientes mais frescos.
                </p>
